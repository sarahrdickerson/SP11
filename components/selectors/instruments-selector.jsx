...
const InstrumentsSelector = ({ selected, setSelected, onRemove }) => {
  return (
        ...
        <div className="flex flex-row gap-1 items-center">
          ...
          <HoverCard openDelay={200}>
            ...
            <HoverCardContent
              ...
              side="left"
            >
              Specify particular instruments to feature in your composition,
              such as Piano, Guitar, Violin, or Drums. This option lets you
              shape the musical arrangement to your preference.
            </HoverCardContent>
          </HoverCard>
        </div>
        <Cross2Icon
